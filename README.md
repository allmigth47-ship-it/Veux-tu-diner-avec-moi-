    ...
    <style>
        * { box-sizing: border-box; }
        html, body {
            ...
            overflow-x: hidden;
            overflow-y: auto; /* Permet un défilement souple si le clavier ou l'écran est petit */
            -webkit-overflow-scrolling: touch;
        }
        .wrapper {
            display: flex;
            justify-content: center;
            align-items: flex-start; /* Aligné en haut pour laisser de la place au scroll mobile */
            width: 100%;
            min-height: 100%;
            padding: 10px;
        }
